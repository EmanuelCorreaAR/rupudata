...
from rupudata.core.models import CompareReport, DatasetRef, OverlapStats
...
def compare_datasets(path_a: str | Path, path_b: str | Path) -> CompareReport:
    ...
    return CompareReport(
        version=__version__,
        dataset_a=_dataset_ref(a_path, df_a, fmt_a.value),
        dataset_b=_dataset_ref(b_path, df_b, fmt_b.value),
